...
class CSPDualFPN(nn.Module):
    def __init__(
        ...
        self.ghost_5_to_4 = CSPLayer(
            in_channels=self.channel_widths[-2] * 2,
            out_channels=self.channel_widths[-2],
        )
        ...
        self.ghost_4_to_3 = CSPLayer(
            in_channels=self.channel_widths[-3] * 2,
            out_channels=self.channel_widths[-3],
        )
        ...
        self.lane_seg_ghost_3_to_2 = Bottleneck(
            in_channels=self.channel_widths[-3], out_channels=self.channel_widths[-3]
        )
        ...
        self.lane_seg_ghost_2_to_1 = Bottleneck(
        ...
        self.lane_seg_ghost_1_to_0 = Bottleneck(
            in_channels=self.channel_widths[-4], out_channels=self.channel_widths[-4]
        )

        # lane-segmentation 32, 512, 512 -> 2, 512, 512
        self.lane_seg_head = Bottleneck(
            in_channels=self.channel_widths[-4], out_channels=2
        )
        # ======================================================================================================== #
        ...
        self.se_seg_ghost_3_to_2 = Bottleneck(
            in_channels=self.channel_widths[-3], out_channels=self.channel_widths[-3]
        )
        ...
        self.se_seg_ghost_2_to_1 = Bottleneck(
            in_channels=self.channel_widths[-4], out_channels=self.channel_widths[-4]
        )
        ...
        self.se_seg_ghost_1_to_0 = Bottleneck(
            in_channels=self.channel_widths[-4], out_channels=self.channel_widths[-4]
        )

        # semantic-segmentation 32, 512, 512 -> num_class_seg, 512, 512
        self.se_seg_head = Bottleneck(
            in_channels=self.channel_widths[-4], out_channels=self.num_class_seg
        )
        # ======================================================================================================== #
